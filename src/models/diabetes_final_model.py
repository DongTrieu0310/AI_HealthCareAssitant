...
X_TRAIN_PATH = "../../data/processed/diabetes_X_train.csv"
Y_TRAIN_PATH = "../../data/processed/diabetes_y_train.csv"
...
print("\n")
print("=" * 60)
print("FINAL DIABETES MODEL COMPLETED")
print("=" * 60)
